...
int main() {
  ...
  for (int i = 0; i < deviceCount; i++) {
    ...
    std::cout << "设备全局内存总量： " << devProp.totalGlobalMem / 1024 / 1024
              << "MB" << std::endl;
